...
**Answer:** for i in seq_along()
- create an empty data frame
- have to create proportions first using a for loop
- then do which.max or max
...
```{r}
s2_cost <- eval_cost_summary(p1, s2[, "solution_1"])

s3_cost <- eval_cost_summary(p1, s3[, "solution_1"])

s4_cost <- eval_cost_summary(p1, s4[, "solution_1"])
```
...
```{r}
pu_s2 <- eval_n_summary(p1, s2[, "solution_1"])

pu_s3 <- eval_n_summary(p1, s3[, "solution_1"])

pu_s4 <- eval_n_summary(p1, s4[, "solution_1"])
```
